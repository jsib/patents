<?php
//Вспомогательная функция к функции my_send_mail(). Используется в ней.
...
//Отсылает письмо по электронной почте с темой $subject и текстом $text.
//Тема и текст должны быть в кодировке utf-8
function my_send_mail($recipient, $subject="test", $text="test mail"){
